...
@Component({
  ...
  template: `
    <header class="glass sticky top-0 z-[40] w-full backdrop-blur-md select-none border-t-0 border-x-0 border-b border-app-border transition-colors duration-300">
      ...
      @if (isMobileMenuOpen()) {
        <div class="lg:hidden absolute left-4 right-4 mt-1 bg-app-card border border-app-border rounded-xl shadow-xl z-50 p-2 animate-in fade-in slide-in-from-top-2 duration-150">
          <div class="flex flex-col gap-1">
            ...
            <div class="px-3 py-2 border-t border-b border-app-border my-1 bg-app-bg/30 rounded-lg">
              <span class="text-[9px] font-bold text-app-muted uppercase tracking-wider block mb-1">Marketing SaaS</span>
